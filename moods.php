...
echo '<div style="font-family: cambria math;text-align: center;font-weight: bold;text-decoration-color: transparent;color: black;"><h1>'.$find.'<br><br></div></h1>';
...
<div class="table">
	...
	<div class="col2">
<?php
$play=mysql_query("select distinct songs from moods where mood='$find'") or die("failed again");$_SESSION['next']=$find;
